...
public class MapManagerHeuristic : MonoBehaviour
...

{
    ...
    private static MapManagerHeuristic _instance;
    public static MapManagerHeuristic Instance { get {return _instance; }}
    ...
    // the current level's world grid bounds within which the whole layout is placed
    [SerializeField] Tilemap LevelGridBounds;             // this represent the final array dimensions for the outer grid layout, this represents the grid and only considers the walkable areas in this grid and not any other area
    // the walkable areas within the world grid
    ...
    void Start()
    {
        ...
        gridMin = LevelGridBounds.cellBounds.min;
        gridMax = LevelGridBounds.cellBounds.max;
