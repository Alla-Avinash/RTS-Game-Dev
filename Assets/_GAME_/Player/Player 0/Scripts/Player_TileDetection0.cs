...
public class Player_TileDetection0 : MonoBehaviour
{
    // detects what tile the player is on and tries to render the player according to
    // the sprite rendering layer and 
    // restricts movement if trying to go into the water or any boundaries
